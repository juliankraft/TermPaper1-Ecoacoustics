...
\usepackage[
    ...
    maxcitenames=1,            % Use "et al." for more than one author in text citations
    maxbibnames=999,           % List all authors in the bibliography
    giveninits=true,           % Abbreviate first names to initials
    useprefix=true,            % List all authors with last name first
